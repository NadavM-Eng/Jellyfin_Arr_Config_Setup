...
| MB-021 | next | Add the same small file for each remaining service. | Service list | Compare every file with the current Compose files, paths, and setup needs. | `added current service files` |
