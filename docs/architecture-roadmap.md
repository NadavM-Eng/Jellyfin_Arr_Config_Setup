...
| MB-022 | next | Add a Quick file that selects everything the current Quick install uses. | Quick choices | Compare it with `quick-stack.txt` and `QUICK_CONFIG_*`; no setup behavior changes. | `added preconfigured Quick installation profile` |
